...
This project was dedicated to providing lk_moe hybrid inference integration for running DeepSeek-V4 on vLLM + SM120. Now that the mainline vLLM DeepSeek-V4 SM120 support has essentially matured, this project will no longer be updated. Please move to the Lvllm[https://github.com/guqiong96/Lvllm] project instead. Thank you.
